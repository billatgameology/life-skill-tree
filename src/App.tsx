    ...
    <div className="fixed inset-0 flex overflow-hidden bg-void">
      ...
      <div className="flex w-full h-full relative z-[1]">
        ...
        <div
          ...
          style={{
            paddingTop: isMobile && (isSidebarOpen || isDetailPanelOpen) ? '50dvh' : 0,
          }}
        >
          {vizMode === 'mosaic' && (
            <MosaicView
        ...
        {isDetailPanelOpen ? (
          selectedPathId ? (
            <div className={isMobile ? 'absolute inset-x-0 top-14 h-[50dvh] z-50 rounded-b-2xl overflow-hidden shadow-2xl border-b border-border' : 'absolute right-3 top-14 h-[70dvh] z-50 rounded-2xl overflow-hidden shadow-2xl border border-border'}>
              <PathDetailPanel
